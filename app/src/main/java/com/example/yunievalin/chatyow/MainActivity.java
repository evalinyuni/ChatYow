...
import com.example.yunievalin.chatyow.ui.FriendsFragment;
import com.example.yunievalin.chatyow.ui.GroupFragment;
import com.example.yunievalin.chatyow.ui.LoginActivity;
import com.example.yunievalin.chatyow.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("Lancer Chat");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Lancer chat version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
